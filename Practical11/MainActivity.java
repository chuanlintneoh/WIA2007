...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int MEDIA_RES_ID = R.raw.dave_koz_sinaran;
    ...
    private class PlaybackListener extends PlaybackInfoListener {
       @Override
        void onDurationChanged(int duration) {
            ...
            Log.d(TAG, String.format(">> Setting playback duration - setMax(%d). [04sub:onDurationChanged()]", duration));
        }
        ...
        void onStateChanged(int state) {
           ...
           onLogUpdated(String.format(">> Changing state - (%s). [04sub:onStateChanged()]", stateToString));
        }
        @Override
